ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :publications do |publication|
    ...
    publication.resources :epi_trans_cts_identifiers, :member => { :add_new_lang_to_xml => :post , :history => :get,  :preview => :get, :editxml => :get, :updatexml => :put, :rename_review => :get, :rename => :put }
    ...
    publication.resources :tei_cts_identifiers, :member => { :history => :get, :preview => :get, :exportxml => :get, :updatexml => :put, :rename_review => :get, :rename => :put, :commentary => :get, :update_commentary => :put, :update_frontmatter_commentary => :put, :delete_commentary => :delete, :delete_frontmatter_commentary => :delete }
