...
function provenanceOrigPlaceUnknownToggle(origPlaceIndex, unknown){
  if(unknown){
    // set value
    $('epi_meta_cite_identifier_origPlace_' + origPlaceIndex + '_value').value = 'unbekannt';
    
    // hide data pane
    $('origPlace_' + origPlaceIndex + '_data').hide();
    
    // delete data
    $('epi_meta_cite_identifier_origPlace_' + origPlaceIndex + '_attributes_type').value = '';
    
    provenanceOrigPlaceGeoDelete(origPlaceIndex);

  } else {
   // reset value
   $('epi_meta_cite_identifier_origPlace_' + origPlaceIndex + '_value').value = '';
...
function provenanceOrigPlaceReferenceTypeToggle(origPlaceIndex, referenceType){
  // set value
  $('epi_meta_cite_identifier_origPlace_' + origPlaceIndex + '_value').value = referenceType;
}

function provenanceOrigPlaceGeoDelete(origPlaceIndex){
  $('epi_meta_cite_identifier_origPlace_' + origPlaceIndex + '_referenceType').value = '';
  $('epi_meta_cite_identifier_origPlace_' + origPlaceIndex + '_attributes_correspondency').value = '';
...
function publicationPreview(){
  preview = $('epi_meta_cite_identifier_publicationTitle').getValue() + ' ' + 
            $('epi_meta_cite_identifier_publicationExtra_0_value').getValue() + ' ' +
            $('epi_meta_cite_identifier_publicationExtra_1_value').getValue() + ' ' +
            $('epi_meta_cite_identifier_publicationExtra_2_value').getValue() + ' ' +
            $('epi_meta_cite_identifier_publicationExtra_3_value').getValue() + ' ';
...
function hideDateTabs(){
  if($($('epi_meta_cite_identifier_textDate_1_attributes_id').parentNode).getElementsBySelector('span')[0].innerHTML.indexOf('(') >= 0){
...
function multiAdd(id)
{
  ...
  var item = '<li>' +
             '  <input type="text" value="' + value + '" name="epi_meta_cite_identifier[' + id + '][' + index + ']" id="epi_meta_cite_identifier_' + id + '_' + index + '" class="observechange">' +
...
function multiAddBl()
{
  ...
  var item = '<li>' +
             '  <input type="text" value="' + volume + '" name="epi_meta_cite_identifier[bl][' + index + '][children][volume][value]" id="epi_meta_cite_identifier_bl_' + index + '_children_volume_value" class="observechange volume">' +
             '  <input type="text" value="' + page + '" name="epi_meta_cite_identifier[bl][' + index + '][children][page][value]" id="epi_meta_cite_identifier_bl_' + index + '_children_page_value" class="observechange page">' +
             '  <span onclick="multiRemove(this.parentNode)" class="delete">x</span>' +
             '  <span class="move">o</span>' +
             '</li>';
...
function multiAddOrigPlaceRaw(e){
  ...
  var item = '<li id="origPlace_' + origPlaceIndex + '" class="origPlace">' + 
             '  <p class="clear">' + 
             '    <input type="text" value="" name="epi_meta_cite_identifier[origPlace][' + origPlaceIndex + '][value]" id="epi_meta_cite_identifier_origPlace_' + origPlaceIndex + '_value" class="observechange provenanceValue">' + 
             '    <input type="checkbox" value="unknown" onchange="provenanceOrigPlaceUnknownToggle(' + origPlaceIndex + ', this.checked)" name="epi_meta_cite_identifier[origPlace][' + origPlaceIndex + '][unknown]" id="epi_meta_cite_identifier_origPlace_' + origPlaceIndex + '_unknown" class="observechange provenanceUnknown">' + 
             '    <label title="/TEI/teiHeader/fileDesc/sourceDesc/msDesc/history/origin/origPlace" for="epi_meta_cite_identifier_origPlace_' + origPlaceIndex + '_unknown" class="meta provenanceUnknown">Unknown</label>' + 
             ...
             '    <p class="clear">' + 
             '      <label title="/TEI/teiHeader/fileDesc/sourceDesc/msDesc/history/origin/origPlace" for="epi_meta_cite_identifier_origPlace_' + origPlaceIndex + '_attributes_type" class="meta provenanceType">Type</label>' + 
             '      <select onchange="provenanceOrigPlaceTypeToggle(' + origPlaceIndex + ', this.value)" name="epi_meta_cite_identifier[origPlace][' + origPlaceIndex + '][attributes][type]" id="epi_meta_cite_identifier_origPlace_' + origPlaceIndex + '_attributes_type" class="observechange provenanceType"><option value=""></option>' + 
             ...
             '      <p class="clear">' + 
             '        <label title="/TEI/teiHeader/fileDesc/sourceDesc/msDesc/history/origin/origPlace" for="epi_meta_cite_identifier_origPlace_' + origPlaceIndex + '_referenceType" class="meta provenanceReferenceType">Reference Type</label>' + 
             '        <select onchange="provenanceOrigPlaceReferenceTypeToggle(' + origPlaceIndex + ', this.value)" name="epi_meta_cite_identifier[origPlace][' + origPlaceIndex + '][referenceType]" id="epi_meta_cite_identifier_origPlace_' + origPlaceIndex + '_referenceType" class="observechange provenanceReferenceType"><option value=""></option>' + 
             '        <option value="Fundort">findspot</option>' + 
             '        <option value="unbekannt">unknown</option></select>' + 
             '      </p>' + 
             '      <p class="clear">' + 
             '        <label title="/TEI/teiHeader/fileDesc/sourceDesc/msDesc/history/origin/origPlace" for="epi_meta_cite_identifier_origPlace_' + origPlaceIndex + '_attributes_correspondency" class="meta provenanceReferenceType">Reference Id</label>' + 
             '        <input type="text" name="epi_meta_cite_identifier[origPlace][' + origPlaceIndex + '][attributes][correspondency]" id="epi_meta_cite_identifier_origPlace_' + origPlaceIndex + '_attributes_correspondency" class="observechange provenanceCorrespondency">' + 
             '      </p>' + 
             '    </div>' + 
...
function multiAddProvenanceRaw(e){
  ...
  var item = '<li id="provenance_' + provenanceIndex + '" class="provenance">' +
             '  <p class="clear">' +
             '    <label title="/TEI/teiHeader/fileDesc/sourceDesc/msDesc/history/provenance/listEvent/event" for="epi_meta_cite_identifier_provenance_' + provenanceIndex + '_attributes_type" class="meta provenanceType">Type</label>' +
             '    <select name="epi_meta_cite_identifier[provenance][' + provenanceIndex + '][attributes][type]" id="epi_meta_cite_identifier_provenance_' + provenanceIndex + '_attributes_type" class="observechange provenanceType"><option value="found">found</option>' +
             ...
             '    <label title="/TEI/teiHeader/fileDesc/sourceDesc/msDesc/history/provenance/listEvent/event" for="epi_meta_cite_identifier_provenance_' + provenanceIndex + '_attributes_subtype" class="meta provenanceSubtype">Subtype</label>' +
             '    <select name="epi_meta_cite_identifier[provenance][' + provenanceIndex + '][attributes][subtype]" id="epi_meta_cite_identifier_provenance_' + provenanceIndex + '_attributes_subtype" class="observechange provenanceSubtype"><option value=""></option>' +
             '    <option value="last">last</option></select>' +
             '    <span title="Click to delete item" onclick="multiRemove(this.parentNode.parentNode)" class="delete">x</span>' +
             '    <span title="Click and drag to move item" class="move">o</span>' +
             '  </p>' +
             '  <p class="clear">' +
             '    <label title="/TEI/teiHeader/fileDesc/sourceDesc/msDesc/history/provenance/listEvent/event" for="epi_meta_cite_identifier_provenance_' + provenanceIndex + '_attributes_id" class="meta provenanceId">ID</label>' +
             '    <input type="text" value="' + id + '" name="epi_meta_cite_identifier[provenance][' + provenanceIndex + '][attributes][id]" id="epi_meta_cite_identifier_provenance_' + provenanceIndex + '_attributes_id" class="observechange provenanceId">' +
             '  </p>' +
             '  <p class="clear">' +
             '    <label title="/TEI/teiHeader/fileDesc/sourceDesc/msDesc/history/provenance/listEvent/event" for="epi_meta_cite_identifier_provenance_' + provenanceIndex + '_attributes_date" class="meta provenanceDate">Date</label>' +
             '    <input type="text" value="" name="epi_meta_cite_identifier[provenance][' + provenanceIndex + '][attributes][date]" id="epi_meta_cite_identifier_provenance_' + provenanceIndex + '_attributes_date" class="observechange provenanceDate">' +
             '  </p>' +
...
function multiAddPlaceRaw(e){
  ...
  var item = '<li>' +
             '   <label for="epi_meta_cite_identifier_' + provenanceType + '_' + provenanceIndex + '_children_' + paragraphUnderscore + 'place_' + placeIndex + '_attributes_id">Place ID</label>' +
             '   <input type="text" value="" name="epi_meta_cite_identifier[' + provenanceType + '][' + provenanceIndex + '][children]' + paragraphBrackets + '[place][' + placeIndex + '][attributes][id]" id="epi_meta_cite_identifier_' + provenanceType + '_' + provenanceIndex + '_children_' + paragraphUnderscore + 'place_' + placeIndex + '_attributes_id" class="observechange provenancePlaceId">' +
             '   <label for="epi_meta_cite_identifier_' + provenanceType + '_' + provenanceIndex + '_children_' + paragraphUnderscore + 'place_' + placeIndex + '_attributes_exclude">Exclude</label>' +
             '   <input type="text" value="" name="epi_meta_cite_identifier[' + provenanceType + '][' + provenanceIndex + '][children]' + paragraphBrackets + '[place][' + placeIndex + '][attributes][exclude]" id="epi_meta_cite_identifier_' + provenanceType + '_' + provenanceIndex + '_children_' + paragraphUnderscore + 'place_' + placeIndex + '_attributes_exclude" class="observechange provenancePlaceExclude">' +
...
function multiAddGeoSpot(key, provenanceIndex, placeIndex)
{
  ...
  var item = '<li>' +
             '  <select name="epi_meta_cite_identifier[' + provenanceType + '][' + provenanceIndex + '][children]' + paragraphBrackets + '[place][' + placeIndex + '][children][geo][' + geoIndex + '][attributes][type]" id="epi_meta_cite_identifier_' + provenanceType + '_' + provenanceIndex + '_children_' + paragraphUnderscore + 'place_' + placeIndex + '_children_geo_' + geoIndex + '_attributes_type" class="observechange provenanceGeoType"><option value="ancient"' + (type == 'ancient' ? ' selected="selected"' : '') + '>ancient</option>' +
             '  <option value="modern"' + (type == 'modern' ? ' selected="selected"' : '') + '>modern</option></select>' +
             '  <select name="epi_meta_cite_identifier[' + provenanceType + '][' + provenanceIndex + '][children]' + paragraphBrackets + '[place][' + placeIndex + '][children][geo][' + geoIndex + '][attributes][subtype]" id="epi_meta_cite_identifier_' + provenanceType + '_' + provenanceIndex + '_children_' + paragraphUnderscore + 'place_' + placeIndex + '_children_geo_' + geoIndex + '_attributes_subtype" class="observechange provenanceGeoSubtype"><option value=""></option>' +
             ...
             '  <select name="epi_meta_cite_identifier[' + provenanceType + '][' + provenanceIndex + '][children]' + paragraphBrackets + '[place][' + placeIndex + '][children][geo][' + geoIndex + '][children][offset][value]" id="epi_meta_cite_identifier_' + provenanceType + '_' + provenanceIndex + '_children_' + paragraphUnderscore + 'place_' + placeIndex + '_children_geo_' + geoIndex + '_children_offset_value" class="observechange provenanceGeoOffset"><option value=""></option>' +
             '  <option value="bei"' + (offset == 'bei' ? ' selected="selected"' : '') + '>near</option></select>' +
             '  <input type="text" value="' + name + '" name="epi_meta_cite_identifier[' + provenanceType + '][' + provenanceIndex + '][children]' + paragraphBrackets + '[place][' + placeIndex + '][children][geo][' + geoIndex + '][value]" id="epi_meta_cite_identifier_' + provenanceType + '_' + provenanceIndex + '_children_' + paragraphUnderscore + 'place_' + placeIndex + '_children_geo_' + geoIndex + '_value" class="observechange provenanceGeoName">' +
             '  <input type="checkbox" value="low" name="epi_meta_cite_identifier[' + provenanceType + '][' + provenanceIndex + '][children]' + paragraphBrackets + '[place][' + placeIndex + '][children][geo][' + geoIndex + '][attributes][certainty]" id="epi_meta_cite_identifier_' + provenanceType + '_' + provenanceIndex + '_children_' + paragraphUnderscore + 'place_' + placeIndex + '_children_geo_' + geoIndex + '_attributes_certainty" class="observechange provenanceGeoCertainty"' + (uncertainty ? ' checked="checked"' : '') + '>' +
             '  <label for="epi_meta_cite_identifier_' + provenanceType + '_' + provenanceIndex + '_children_' + paragraphUnderscore + 'place_' + placeIndex + '_children_geo_' + geoIndex + '_attributes_certainty" class="geoSpotUncertain">uncertain</label>' +
             '  <span title="Click to delete item" onclick="multiRemove(this.parentNode)" class="delete">x</span>' +
             '  <span title="Click and drag to move item" class="move">o</span>' +
             '  <div class="paragraph geoReferenceContainer"' + ($('toggleReferenceList').hasClassName('showReferenceList') ? ' style="display: none;"' : '') + '>' +
             '    <input type="text" value="' + referenceString + '" name="epi_meta_cite_identifier[' + provenanceType + '][' + provenanceIndex + '][children]' + paragraphBrackets + '[place][' + placeIndex + '][children][geo][' + geoIndex + '][attributes][reference]" id="epi_meta_cite_identifier_' + provenanceType + '_' + provenanceIndex + '_children_' + paragraphUnderscore + 'place_' + placeIndex + '_children_geo_' + geoIndex + '_attributes_reference" class="observechange provenanceGeoReference">' +
             '    <label for="epi_meta_cite_identifier_' + provenanceType + '_' + provenanceIndex + '_children_' + paragraphUnderscore + 'place_' + placeIndex + '_children_geo_' + geoIndex + '_attributes_reference">Reference</label>' +
  ...
  for(i = 0; i < referenceList.length; i++){
    ...
    item +=  '        <li>' +
             '          <input type="text" value="' + referenceList[i] + '" name="epi_meta_cite_identifier[' + referenceKey + '][' + i + ']" id="epi_meta_cite_identifier_' + referenceKey + '_' + i + '" class="observechange">' +
             '          <span title="Click to delete item" onclick="multiRemove(this.parentNode)" class="delete">x</span>' +
             '          <span title="Click and drag to move item" class="move">o</span>' +
             '        </li>';
  }
...
function multiAddPublicationExtra()
{
  ...
  var item = '<li>' +
             '  <input class="observechange publicationExtra" id="epi_meta_cite_identifier_publicationExtra_' + index + '_value" name="epi_meta_cite_identifier[publicationExtra][' + index + '][value]" type="text" value="' + value + '" />' + 
             '  <input class="observechange publicationExtra" id="epi_meta_cite_identifier_publicationExtra_' + index + '_attributes_type" name="epi_meta_cite_identifier[publicationExtra][' + index + '][attributes][type]" type="hidden" value="' + type + '" />' +
             '  <span onclick="multiRemove(this.parentNode)" class="delete">x</span>' +
             '  <span class="move">o</span>' +
             '</li>';
...
function multiAddFigures()
{
  ...
  var item = '<li>' +
             '  <input type="text" value="' + url + '" name="epi_meta_cite_identifier[figures][' + index + '][children][graphic][attributes][url]" id="epi_meta_cite_identifier_figures_' + index + '_children_graphic_attributes_url" class="observechange">' +
             '  <span onclick="multiRemove(this.parentNode)" class="delete">x</span>' +
             '  <span class="move">o</span>' +
             '</li>';
...
function multiAddMentionedDate()
{
  ...
  var item = '<li>' +
             '  <input type="text" value="' + reference +  '" name="epi_meta_cite_identifier[mentionedDate][' + index +  '][children][ref][value]" id="epi_meta_cite_identifier_mentionedDate_' + index +  '_children_ref_value" class="observechange reference">' +
             '  <input type="text" value="' + comment +  '" name="epi_meta_cite_identifier[mentionedDate][' + index +  '][children][comment][value]" id="epi_meta_cite_identifier_mentionedDate_' + index +  '_children_comment_value" class="observechange comment">' +
             '  <input type="text" value="' + date1 +  '" onchange="mentionedDateNewDate(this)" name="epi_meta_cite_identifier[mentionedDate][' + index +  '][date1]" id="epi_meta_cite_identifier_mentionedDate_' + index +  '_date1" class="observechange">' +
             '  <input type="text" value="' + date2 +  '" onchange="mentionedDateNewDate(this)" name="epi_meta_cite_identifier[mentionedDate][' + index +  '][date2]" id="epi_meta_cite_identifier_mentionedDate_' + index +  '_date2" class="observechange">' +
             '  <input type="hidden" value="" name="epi_meta_cite_identifier[mentionedDate][' + index +  '][children][date][attributes][when]" id="epi_meta_cite_identifier_mentionedDate_' + index +  '_children_date_attributes_when">' +
             '  <input type="hidden" value="" name="epi_meta_cite_identifier[mentionedDate][' + index +  '][children][date][attributes][notBefore]" id="epi_meta_cite_identifier_mentionedDate_' + index +  '_children_date_attributes_notBefore">' +
             '  <input type="hidden" value="" name="epi_meta_cite_identifier[mentionedDate][' + index +  '][children][date][attributes][notAfter]" id="epi_meta_cite_identifier_mentionedDate_' + index +  '_children_date_attributes_notAfter">' +
             '  <input type="text" value="' + annotation +  '" name="epi_meta_cite_identifier[mentionedDate][' + index +  '][children][annotation][value]" id="epi_meta_cite_identifier_mentionedDate_' + index +  '_children_annotation_value" class="observechange annotation">' +
             '  <select onchange="mentionedDateNewCertainty(this)" name="epi_meta_cite_identifier[mentionedDate][' + index +  '][certaintyPicker]" id="epi_meta_cite_identifier_mentionedDate_' + index +  '_certaintyPicker" class="observechange certainty"><option value=""></option>' +
             ...
             '  <select name="epi_meta_cite_identifier[mentionedDate][' + index +  '][children][date][children][certainty][0][attributes][relation]" id="epi_meta_cite_identifier_mentionedDate_' + index +  '_children_date_children_certainty_0_attributes_relation" class="observechange dateId"><option value=""></option>' +
             ...
             '  <input type="hidden" value="1" name="epi_meta_cite_identifier[mentionedDate][' + index +  '][children][date][children][certainty][0][attributes][degree]" id="epi_meta_cite_identifier_mentionedDate_' + index +  '_children_date_children_certainty_0_attributes_degree">' +
             '  <span title="Click to delete item" onclick="multiRemove(this.parentNode)" class="delete">x</span>' +
             '  <span title="Click and drag to move item" class="move">o</span>' +
             '</li>';
  ...
  mentionedDateNewDate($('epi_meta_cite_identifier_mentionedDate_' + index +  '_date1'));
}
...
function mentionedDateNewDate(dateinput)
{
  ...
  var date1 = $('epi_meta_cite_identifier_mentionedDate_' + index + '_date1').value;
  var date2 = $('epi_meta_cite_identifier_mentionedDate_' + index + '_date2').value;
  
  if(date2 && date2 != ''){
    $('epi_meta_cite_identifier_mentionedDate_' + index + '_children_date_attributes_notBefore').value = date1;
    $('epi_meta_cite_identifier_mentionedDate_' + index + '_children_date_attributes_notAfter').value  = date2;
  } else {
    $('epi_meta_cite_identifier_mentionedDate_' + index + '_children_date_attributes_when').value      = date1;
  }

  mentionedDateNewCertainty($('epi_meta_cite_identifier_mentionedDate_' + index + '_certaintyPicker')); // update certainties as well
}
...
function mentionedDateGetDateTyes(index){
  ...
  for(dateTypeIndex = 0; dateTypeIndex < dateTypes.length; dateTypeIndex++){
    var dateType = $('epi_meta_cite_identifier_mentionedDate_' + index + '_children_date_attributes_' +  dateTypes[dateTypeIndex]);
...
function mentionedDateNewCertainty(selectbox)
{
  ...
  if (value.length) {
    if (value == 'low') { // global    
      $(selectbox).parentNode.insert('<input type="hidden" value="low" name="epi_meta_cite_identifier[mentionedDate][' + index + '][children][date][attributes][certainty]" id="epi_meta_cite_identifier_mentionedDate_' + index + '_children_date_attributes_certainty">');
    }
    else { // specific
      ...
      for (i = 0; i < dateBits.length; i++) {
        ...
        for (j = 0; j < dateTypes.length; j++) {
          ...
          $(selectbox).parentNode.insert('<input type="hidden" value="../date/' + dateBits[i] + '-from-date(@' + dateType + ')" name="epi_meta_cite_identifier[mentionedDate][' + index + '][children][date][children][certainty][' + certaintyIndex + '][attributes][match]" id="epi_meta_cite_identifier_mentionedDate_' + index + '_children_date_children_certainty_' + certaintyIndex + '_attributes_match">');
          certaintyIndex++;
        }
      }
    }
...
Event.observe(window, 'load', function() {
  ...
  $$('.quickSave').each(function(e){e.observe('click', function(e){checkNotAddedMultiples(); geoReferenceWizard(); rememberToggledView(); set_conf_false(); $$('form.edit_epi_meta_cite_identifier')[0].submit();});});
  ...
  /* provenance
  $('epi_meta_cite_identifier_provenance_0_value').observe('click', function(event){provenanceUnknown();});
  
  new Ajax.Autocompleter('provenance_ancientFindspot', 'autocompleter_provenanceAncientFindspot', '/epi_meta_cite_identifiers/autocomplete', {parameters: 'key=provenance_ancientFindspot&type=ancient&subtype=settlement', afterUpdateElement: function(input, li){
    
    new Ajax.Request('/epi_meta_cite_identifiers/complement', {parameters : 'type=ancient&subtype=settlement&value=' + $('provenance_ancientFindspot').value, evalJSON : true, onSuccess : function(t){
  ...
  new Ajax.Autocompleter('provenance_modernFindspot', 'autocompleter_provenanceModernFindspot', '/epi_meta_cite_identifiers/autocomplete', {parameters: 'key=provenance_modernFindspot&type=modern&subtype=settlement', afterUpdateElement: function(input, li){
    
    new Ajax.Request('/epi_meta_cite_identifiers/complement', {parameters : 'type=modern&subtype=settlement&value=' + $('provenance_modernFindspot').value, evalJSON : true, onSuccess : function(t){
  ...
  new Ajax.Autocompleter('provenance_nome', 'autocompleter_provenanceNome', '/epi_meta_cite_identifiers/autocomplete', {parameters: 'key=provenance_nome&type=ancient&subtype=nome', afterUpdateElement: function(input, li){
    
    new Ajax.Request('/epi_meta_cite_identifiers/complement', {parameters : 'type=ancient&subtype=nome&value=' + $('provenance_nome').value, evalJSON : true, onSuccess : function(t){
  ...
  new Ajax.Autocompleter('provenance_ancientRegion', 'autocompleter_provenanceAncientRegion', '/epi_meta_cite_identifiers/autocomplete', {parameters: 'key=provenance_ancientRegion&type=ancient&subtype=region'});
